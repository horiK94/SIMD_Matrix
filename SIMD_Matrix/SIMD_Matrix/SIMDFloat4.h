...
struct SIMDFloat4
{
	...
	SIMDFloat4(__m128 e);
	SIMDFloat4 operator+(SIMDFloat4 v) const;
	SIMDFloat4& operator+=(SIMDFloat4 v);
	SIMDFloat4 operator+() const;
	SIMDFloat4 operator-(SIMDFloat4 v) const;
	SIMDFloat4& operator-=(SIMDFloat4 v);
	SIMDFloat4 operator-() const;
	SIMDFloat4 operator*(float k) const;
	friend SIMDFloat4 operator*(float k, SIMDFloat4 v);
	SIMDFloat4& operator*=(float k);
	SIMDFloat4 operator/(float k) const;
	SIMDFloat4& operator/=(float k);
	bool equal(SIMDFloat4 v, float epsilon = 0.01) const;
	bool isZero() const;
	...
	static SIMDFloat4 Dot(SIMDFloat4 v1, SIMDFloat4 v2);
	static SIMDFloat4 Normalize(SIMDFloat4 v);
};
